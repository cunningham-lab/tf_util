...
def test_AL_cost():
	...
	costs_true, grads_true, H_true = aug_lag_cost(log_q_z, T_x_mu_centered, Lambda, c, all_params, 3)
	...
	with tf.Session() as sess:
		...
		_grads_true, _grads = sess.run([grads_true, grads], {W:_W, Lambda:_lambda, c:_c})
...
def test_log_grads():
	...
	new_grads2_2 = [np.random.normal(0.0, 1.0, (2,4)), np.random.normal(4.0, 1.0, (4,3))]
